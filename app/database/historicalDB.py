...
class InfluxDBStorage:
  ...
  def check_auth(self) -> bool:
    ...
    """
    try:
      # self.buckets_api sudah berupa instance BucketsApi (lihat __init__),
      # jadi jangan dipanggil. find_buckets() juga hanya menerima kwargs.
  ...
  def _create_point(
    ...
    # Optional fields
    if actual is not None: point = point.field("actual", float(actual))
    if features: point = point.field("features", json.dumps(features))
